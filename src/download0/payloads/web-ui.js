...
function scan_js_files() {
  ...
  while (true) {
    var ret = getdents_sys(dir_fd, dirent_buf, new BigInt(1024)).lo;
    if (ret <= 0) break;
    var offset = 0;
    while (offset < ret) {
...
function handleRequest() {
  ...
  if (path === '/load' || (path === null || path === void 0 ? void 0 : path.indexOf('/load?')) === 0) {
  ...
  } else if ((path === null || path === void 0 ? void 0 : path.indexOf('/load/')) === 0) {
